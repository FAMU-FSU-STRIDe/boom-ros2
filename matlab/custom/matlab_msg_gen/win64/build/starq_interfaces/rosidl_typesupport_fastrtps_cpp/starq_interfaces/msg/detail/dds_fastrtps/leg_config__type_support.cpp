...
#include "starq_interfaces/msg/detail/leg_config__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const starq_interfaces::msg::LegConfig & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: id
  cdr << ros_message.id;
  // Member: kinematic_type
  cdr << ros_message.kinematic_type;
  // Member: motor_ids
  {
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  starq_interfaces::msg::LegConfig & ros_message)
{
  // Member: id
  cdr >> ros_message.id;
...
{
  auto typed_message =
    static_cast<const starq_interfaces::msg::LegConfig *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<starq_interfaces::msg::LegConfig *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _LegConfig__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const starq_interfaces::msg::LegConfig *>(
...
{
  return max_serialized_size_LegConfig(full_bounded, 0);
}

static message_type_support_callbacks_t _LegConfig__callbacks = {
...
static rosidl_message_type_support_t _LegConfig__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_LegConfig__callbacks,
...
{
  return &starq_interfaces::msg::typesupport_fastrtps_cpp::_LegConfig__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, starq_interfaces, msg, LegConfig)() {
  return &starq_interfaces::msg::typesupport_fastrtps_cpp::_LegConfig__handle;
}
