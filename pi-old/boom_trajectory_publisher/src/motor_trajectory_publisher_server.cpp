...
#include <boom_interfaces/action/run_motor_trajectory.hpp>
...
public:
    ...
    using RunMotorTrajectory = boom_interfaces::action::RunMotorTrajectory;
    ...
    : rclcpp::Node("trajectory_publisher", options), is_running_(false), is_in_fault_state_(false), fault_(0) {
        ...
        this->action_server_ = rclcpp_action::create_server<RunMotorTrajectory>(this, "/boom/motors/run_trajectory",
        ...
        this->motor_cmd_pub_ = this->create_publisher<ODriveCommandArray>("/boom/motors/cmd", 10);
...
RCLCPP_COMPONENTS_REGISTER_NODE(boom::MotorTrajectoryPublisherServer)