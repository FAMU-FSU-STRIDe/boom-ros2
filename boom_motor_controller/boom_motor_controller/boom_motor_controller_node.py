...
from boom_interfaces.msg import *
from boom_interfaces.srv._configure_motors import *
from boom_motor_controller.odrive_can_tool import ODriveCANTool

class BoomMotorDriverNode(Node):
    ...
    def __init__(self):
        ...
        self.cmd_sub = self.create_subscription(ODriveCommandArray, '/boom/motors/cmd', self.cmd_motors_callback, 10)
        self.conf_srv = self.create_service(ConfigureMotors, '/boom/motors/conf', self.conf_motors_callback)
        self.info_pub = self.create_publisher(ODriveInfoArray, '/boom/motors/info', 10)
